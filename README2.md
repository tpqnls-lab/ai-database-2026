...
![](assets/20260922_090422_image.png)
...
![](https://github.com/hugoMGSung/ai-database-2026/raw/main/assets/20260921_101521_image.png)
...
* URL기본 `http(s)://address:port`
  * address - 127.0.0.1 또는 192.168.0.105 등 아이피주소, [www.naver.com](http://www.naver.com/), google.com 등의 도메인주소
  * port - 0 \~ 65535까지의 숫자
* `/` - root 기본되는 페이지
...
![](https://github.com/hugoMGSung/ai-database-2026/raw/main/assets/20260921_112812_image.png)
...
![](https://github.com/hugoMGSung/ai-database-2026/raw/main/assets/20260921_135822_image.png)

* 실행결과

![](https://github.com/hugoMGSung/ai-database-2026/raw/main/assets/20260921_142035_image.png)
...
- 실제 DB(PostgreSQL) 연동, 데이터를 가져와 사용하는 웹서버 구현
- 일반적인 API 서버구조
...
- database.py 를 호출해서 실제 DB연결과 FastAPI 작업을 병행
...
- `F5`(디버그 모드)로 실행
- 디버깅이 필요한 함수나 로직에 `F9`로 종단점(Break Point) 활성화
- 로직 실행하면 종단점에 일시 중단
- `F10` 또는 `F11`로 한 줄씩 실행하면서 로직 처리 결과 모니터링, 조사식과 변수에서 데이터 확인
- 오류 로직 찾아서 수정
- 다시 디버깅으로 정상 동작 확인하고 완료
